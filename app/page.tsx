    ...
    <React.Fragment>
      ...
      <title>PdNode Beta - All beta projects are in here</title>
        <Stack direction={"row"} spacing={5} className={"navi-bar"}>
          ...
          <div>
            <Stack direction="row" spacing={2} sx={{marginTop:"13px", justifyItems:"center"}}>
              <Button href="/" sx={{background:"rgb(119 87 74)", borderRadius:"100px", height:"35px", width:"45px"}}><HomeIcon sx={{color:"#fefbff"}}/></Button>
